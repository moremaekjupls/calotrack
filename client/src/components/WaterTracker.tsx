...
export function WaterTracker({ consumed, goal, hasLogs, onAddCup, onAddCustom, onUndo }: WaterTrackerProps) {
  ...
  return (
    <Card className="bg-gradient-to-br from-[color-mix(in_oklch,var(--chart-5)_22%,white)]/85 to-white/80 backdrop-blur-xl backdrop-saturate-150 border border-[oklch(0.97_0.01_240)]/55 shadow-[inset_0_1px_0_0_rgba(255, 255, 255,0.55),0_8px_24px_-8px_rgba(0,0,0,0.35)] p-5 sm:p-6 animate-fade-in-up">
      ...
      <div className="flex flex-col items-center">
        <button
          ...
          className="relative w-28 h-40 sm:w-32 sm:h-44 rounded-[16px_16px_40px_40px] border-[3px] border-[var(--chart-5)] bg-[oklch(0.97_0.01_240)]/60 overflow-hidden transition-transform active:scale-95"
        >
          {/* liquid fill */}
          <div
          ...
          {/* glass shine */}
          <div className="absolute top-3 left-3 w-2 h-[65%] rounded-full bg-[oklch(0.97_0.01_240)]/40" />
        </button>
