...
export function MealList({ entries, onEdit, onDelete }: MealListProps) {
  if (entries.length === 0) {
    return (
      <Card className="border-dashed border-[oklch(0.97_0.01_240)]/55 bg-[oklch(0.97_0.01_240)]/85 backdrop-blur-xl backdrop-saturate-150 shadow-[inset_0_1px_0_0_rgba(255, 255, 255,0.55),0_8px_24px_-8px_rgba(0,0,0,0.35)]">
