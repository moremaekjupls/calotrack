...
export function MealList({ entries, onEdit, onDelete }: MealListProps) {
  if (entries.length === 0) {
    return (
      <Card className="border-dashed border-[oklch(0.97_0.012_70)]/35 bg-[oklch(0.97_0.012_70)]/22 backdrop-blur-xl backdrop-saturate-200 shadow-[inset_0_1px_0_0_rgba(255, 248, 238,0.55),0_8px_24px_-8px_rgba(0,0,0,0.35)]">
